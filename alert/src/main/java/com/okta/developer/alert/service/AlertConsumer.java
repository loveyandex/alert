...
import com.okta.developer.alert.service.StoreAlertDTO;
...
public class AlertConsumer {
    ...
    public AlertConsumer(KafkaProperties kafkaProperties, StoreAlertRepository storeAlertRepository ) {
...
//                        emailService.sendSimpleMessage(storeAlertDTO);
                        ...
                        log.debug("recuxe store alert for storeAlert: {}", storeAlert);
                        log.info("recuxe store alert for storeAlert: {}", storeAlert);
                    }
                }
