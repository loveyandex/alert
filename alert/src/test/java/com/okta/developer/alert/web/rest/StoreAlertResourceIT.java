...
class StoreAlertResourceIT {
    ...
    void createStoreAlert() throws Exception {
        ...
        restStoreAlertMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(storeAlert)))
    ...
    void putWithMissingIdPathParamStoreAlert() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restStoreAlertMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(storeAlert)))
    ...
    void partialUpdateStoreAlertWithPatch() throws Exception {
        ...
        partialUpdatedStoreAlert.storeName(UPDATED_STORE_NAME).timestamp(UPDATED_TIMESTAMP);
    ...
    void patchWithMissingIdPathParamStoreAlert() throws Exception {
        ...
        restStoreAlertMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(storeAlert))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteStoreAlert() throws Exception {
        ...
        restStoreAlertMockMvc
            .perform(delete(ENTITY_API_URL_ID, storeAlert.getId()).accept(MediaType.APPLICATION_JSON))
