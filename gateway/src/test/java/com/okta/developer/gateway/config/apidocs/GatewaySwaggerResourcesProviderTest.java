package com.okta.developer.gateway.config.apidocs;

import static com.okta.developer.gateway.config.apidocs.GatewaySwaggerResourcesProvider.swaggerResource;
